...
CREATE DATABASE IF NOT EXISTS `gaulois` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `gaulois`;

-- Listage de la structure de la table gaulois. autoriser_boire
...
-- Listage de la structure de la table gaulois. bataille
...
-- Listage de la structure de la table gaulois. boire
...
-- Listage des données de la table gaulois.boire : ~30 rows (environ)
...
-- Listage de la structure de la table gaulois. casque
...
-- Listage de la structure de la table gaulois. composer
...
-- Listage de la structure de la table gaulois. ingredient
...
-- Listage de la structure de la table gaulois. lieu
...
-- Listage de la structure de la table gaulois. personnage
...
-- Listage de la structure de la table gaulois. potion
...
-- Listage de la structure de la table gaulois. prendre_casque
...
-- Listage de la structure de la table gaulois. specialite
...
-- Listage de la structure de la table gaulois. type_casque
